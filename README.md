...
This is just an edited original [One Dark](https://atom.io/themes/one-dark-syntax) syntax, but this one is made more **colorful** and **darker**.
...
I recommend to use this syntax with the original [one-dark UI theme](https://atom.io/themes/one-dark-ui), it looks way better than the other built-in UI themes.
...
Go to **Settings > Install** and next to the search bar select **themes**, than search for `darker-one-dark-syntax`. And just install it with the button.
